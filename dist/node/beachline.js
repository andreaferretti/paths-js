...
function Beachline(item, parent, l, r, cEvent) {
  ...
  Beachline.prototype.addArc = function (newArcSite, arcsNodes) {
    ...
    if (lArcNode != undefined && lArcNode.cEvent != undefined) lArcNode.cEvent.arcsNodes[2] = crossedArcNode.l;
    if (rArcNode != undefined && rArcNode.cEvent != undefined) rArcNode.cEvent.arcsNodes[0] = crossedArcNode.r.r;
  };
  ...
  Beachline.prototype.rmArc = function (newEdgeStart, arcsNodes, edgesNodes) {
    ...
    if (midEdgeNode.isRChild()) midEdgeNode.parent.r = liveCutBranch;else midEdgeNode.parent.l = liveCutBranch;
