...
Fortune.prototype.addCircleEvent = function (arcNode, sweepY, approx) {
    ...
    if (lArcNode === undefined || rArcNode === undefined || lArcNode.item[0] === rArcNode.item[0] && lArcNode.item[1] === rArcNode.item[1] || !_geom2["default"].doHalflinesCross(lEdgeNode.item, rEdgeNode.item)) return;
...
Fortune.prototype.getEdges = function () {
    ...
    while (this.events.length > 0) {
        if (this.events[0].arcsNodes) this.manageCircleEvent();else this.manageSiteEvent();
        this.iterations++;
    };
    return this.edges;
};
