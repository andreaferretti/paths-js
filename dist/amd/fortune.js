define(["exports", "module", "./beachline", "./geom", "./event"], function (exports, module, _beachline, _geom, _event) {
    ...
    Fortune.prototype.addCircleEvent = function (arcNode, sweepY, approx) {
        ...
        if (lArcNode === undefined || rArcNode === undefined || lArcNode.item[0] === rArcNode.item[0] && lArcNode.item[1] === rArcNode.item[1] || !_Geom["default"].doHalflinesCross(lEdgeNode.item, rEdgeNode.item)) return;
