define(['exports', 'module', './linear', './ops'], function (exports, module, _linear, _ops) {
  'use strict';
  ...
  module.exports = function (_ref4) {
    ...
    var xscale = (0, _Linear['default'])([xmin, xmax], [0, width]);
    var yscale = (0, _Linear['default'])([ymin, ymax], [height, 0]);
